...
/**
 * V2 API for listing the collections hosted by this Solr cluster
 *
 * <p>This API is analogous to the v1 /admin/collections?action=LIST command.
 */
@Path("/collections")
public class ListCollectionsAPI extends AdminAPIBase {
  ...
  @GET
  @Operation(summary = "List all collections known to Solr")
  ...
  public ListCollectionsResponse listCollections() {
    ...
    final List<String> collectionList = new ArrayList<>(collections.keySet());
  ...
  public static class ListCollectionsResponse extends SolrJerseyResponse {
    ...
    @Schema(description = "The collections currently hosted by this Solr cluster.")
