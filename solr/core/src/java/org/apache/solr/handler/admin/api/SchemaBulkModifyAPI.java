...
/**
 * V2 API to make 1 or more modifications to an in-use schema.
 *
 * This API (POST /v2/collections/collectionName/schema) is analogous to the v1 /solr/collectionName/schema API.
 */
