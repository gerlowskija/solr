...
public class RestoreCollectionAPITest extends SolrTestCaseJ4 {
    ...
    public void testReportsErrorIfProvidedCollectionNameIsInvalid() {
        ...
        assertEquals(400, thrown.code());
        MatcherAssert.assertThat(thrown.getMessage(), containsString("Invalid collection: [invalid$collection@name]"));
    }
    ...
    public void testCreatesValidRemoteMessageForExistingCollectionRestore() {
        ...
        final var remoteMessage = RestoreCollectionAPI.createRemoteMessage("someBackupName", requestBody).getProperties();
    ...
    public void testCanConvertV1ParamsIntoV2RequestBody() {
        ...
        final var requestBody = RestoreCollectionAPI.RestoreCollectionRequestBody.fromV1Params(v1Params);
